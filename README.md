...
| Surface Finish | Theoretical Ra and RMS (Rq) approximations and cusp (peak-to-valley) height; reminds the user to verify the roughness parameter/standard on the drawing |
